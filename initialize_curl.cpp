...
void UrT_XLR_Parser::initialize_curl(CURL *&conn, const std::string& url, std::string &dataBuffer)
{
	CURLcode code;
...
size_t UrT_XLR_Parser::write_data(char *data, size_t size, size_t nmemb, std::string &dataBuffer)
{
	int realSize;
